...
This program will demonstrate the basic functionality, that is currently
available. Note that everything has been created from scratch: there is 
no second engine this system is built upon, it is pure Direct3D 11 and
elegant C++11.
